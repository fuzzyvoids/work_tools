...
# This script based upon a template provided by Splunk:
# https://help.splunk.com/en/splunk-enterprise/forward-and-process-data/universal-forwarder-manual/10.4/upgrade-or-uninstall-the-universal-forwarder/upgrade-the-universal-forwarder
